...
$backendBuildScript = Join-Path $BackendV8Root "build-v8-13.8-windows.ps1"
$syncScript = Join-Path $cliRoot "sync-v8-13.8-backend-windows.ps1"
...
Write-Host "V8 13.8 Maglev On backend 已由 backend-v8 构建并同步到 PuerTS。"
